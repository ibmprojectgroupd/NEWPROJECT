			...
			<table class="table table-bordered" id="prod">
				<tbody>
					<tr>
						<td>Prodcut Image</td>
						<td>
							<img style="width: 150px; height: 300px;" src="<c:url value='/resource/images/products/${product.id}.jpg'/>">
						</td>
					</tr>
					<tr>
						<td>ID</td>
							...
							<div ng-controller="myController">
								<security:authorize access="hasRole('ROLE_USER')">
									<a href="#" ng-click="addToCart(${product.id})"
										...
										<span class="glyphicon glyphicon-shopping-cart">AddToCart</span>
									</a>
								</security:authorize>
								<a href="<c:url value="/getAllProducts" />" class="btn btn-info"
									style="margin-top: 0px; width: 150px; float: right; margin-right: 31px;">
									<span class="glyphicon glyphicon-arrow-left">AllProducts</span>
								</a>
							</div></td>
					</tr>
				</tbody>
